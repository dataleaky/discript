...
declare type ImageSize = 16 | 32 | 64 | 128 | 256 | 512 | 1024 | 2048 | 4096;
declare type ImageFormat = 'jpg' | 'jpeg' | 'png' | 'webp' | 'gif';
...
export { JSONObjectType, DiscordLocales, PartialObject, ImageParams, UnknownObject, ClientObject, KeyValueParse };
