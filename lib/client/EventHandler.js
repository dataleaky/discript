                ...
                switch (payload.t) {
                    ...
                    case 'GUILD_EMOJIS_UPDATE': {
                        ...
                        for (const object of payload.d.emojis) {
                            ...
                            collection.set(subject.flake.id, subject, true);
                        }
                    ...
                    case 'GUILD_MEMBER_UPDATE': {
                        this._client.handler.say('serverMemberEdit', payload.d.guild_id, new User_1.default({ _client: this._client, ...payload.d.user }), payload.d.roles, Date.parse(payload.d.joined_at), payload.d.nick, payload.d.premium_since === undefined || payload.d.premium_since === null ? payload.d.premium_since : Date.parse(payload.d.premium_since), payload.d.pending);
                        break;
                    }
