...
class User extends Base_1.default {
    ...
    getAvatarURL(params) {
        return this.avatar === undefined || this.avatar === null ? this.tag === undefined ? null : this._client.getDefaultUserAvatarURL({ tag: this.tag }) : this._client.getUserAvatarURL({ ...params, avatar: this.avatar, userID: String(this.flake.id) });
    }
    getFlags() {
