...
class User extends Base.default {
  constructor(data) {
    super();
  ...
  getAvatarURL(params) {
    return this.avatar === null || this.avatar === undefined ? this.tag === undefined ? null : this.client.getUserAvatarDefaultURL({ tag: this.tag }) : this.client.getUserAvatarURL({ format: params.format, size: params.size, avatar: this.avatar, id: String(this.flake.id) });
  }
  getFlags() {
