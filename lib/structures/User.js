...
class User extends Base_1.default {
    ...
    getAvatarURL(params) {
        return this.avatar === null || this.avatar === undefined ? this.tag === undefined ? null : this.client.getDefaultUserAvatarURL({ userDiscriminator: this.tag }) : this.client.getUserAvatarURL({ format: params.format, size: params.size, avatar: this.avatar, id: String(this.flake.id) });
    }
    getFlags() {
