...
class Application extends Base_1.default {
    constructor(data) {
        ...
        this.owner = new User_1.default({ client: this.client, ...data.owner });
        this.summary = data.summary;
        this.verifyKey = data.verify_key;
        this.team = data.team === null ? null : new Team({ client: this.client, ...data.team });
    ...
    getIconURL(params) {
        return this.icon === null ? this.icon : this.client.getApplicationIconURL({ format: params.format, size: params.size, icon: this.icon, applicationID: String(this.flake.id) });
    }
}
class Team extends Base_1.default {
    ...
    getIconURL(params) {
        return this.icon === null ? this.icon : this.client.getTeamIconURL({ format: params.format, size: params.size, teamIcon: this.icon, teamID: String(this.flake.id) });
    }
}
