...
class Application extends Base_1.default {
    ...
    getIconURL(params) {
        return this.icon === null ? this.icon : this.client.getApplicationIconURL({ format: params.format, size: params.size, icon: this.icon, appID: String(this.flake.id) });
    }
}
class Team extends Base_1.default {
    ...
    getIconURL(params) {
        return this.icon === null ? this.icon : this.client.getTeamIconURL({ format: params.format, size: params.size, icon: this.icon, id: String(this.flake.id) });
    }
}
