...
class App extends Base_1.default {
    constructor(data) {
        ...
        this.owner = data.owner === undefined ? data.owner : new User_1.default({ client: this._client, ...data.owner });
        this.summary = data.summary;
        this.verifyKey = data.verify_key;
        this.team = data.team === undefined || data.team === null ? null : new Team({ client: this._client, ...data.team });
...
class Team extends Base_1.default {
    constructor(data) {
        ...
        this.members = data.members === undefined ? data.members : (() => {
            ...
            for (const object of data.members) {
                const subject = new TeamMember({ client: this._client, ...object });
    ...
    getIconURL(params) {
        return this.icon === undefined || this.icon === null ? this.icon : this._client.getTeamIconURL({ ...params, icon: this.icon, id: String(this.flake.id) });
    }
}
