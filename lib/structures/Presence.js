...
class ActivityEmoji extends Base_1.default {
    ...
    getEmojiURL(params) {
        return this.flake === undefined ? undefined : this.client.getCustomEmojiURL({ size: params.size, animated: Boolean(this.isAnimated), emojiID: String(this.flake.id) });
    }
}
...
class ActivityAssets extends Base_1.default {
    ...
    getLargeImageURL(params) {
        return this.appFlake === undefined ? this.appFlake : this.largeImage === undefined ? this.largeImage : this.client.getApplicationAssetURL({ format: params.format, size: params.size, assetID: this.largeImage, applicationID: String(this.appFlake.id) });
    }
    getSmallImageURL(params) {
        return this.appFlake === undefined ? this.appFlake : this.smallImage === undefined ? this.smallImage : this.client.getApplicationAssetURL({ format: params.format, size: params.size, assetID: this.smallImage, applicationID: String(this.appFlake.id) });
    }
}
