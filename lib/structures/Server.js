...
exports.VoiceRegion = exports.Template = exports.ServerWidget = exports.ServerPreview = exports.ServerMember = exports.Role = exports.Emoji = exports.Ban = void 0;
...
class Server extends Base.default {
  constructor(data) {
    super();
    ...
    this.ownerFlake = data.owner_id === undefined ? data.owner_id : new Flake.default(data.owner_id);
    this.bitPermission = data.permissions === undefined ? data.permissions : new Permission.BitSet(data.permissions);
    this.region = data.region;
    this.afkChannelFlake = data.afk_channel_id === undefined || data.afk_channel_id === null ? data.afk_channel_id : new Flake.default(data.afk_channel_id);
    this.afkTimeout = data.afk_timeout;
    this.isWidget = data.widget_enabled;
    this.widgetChannelFlake = data.widget_channel_id === undefined || data.widget_channel_id === null ? data.widget_channel_id : new Flake.default(data.widget_channel_id);
    ...
    this.applicationFlake = data.application_id === undefined || data.application_id === null ? data.application_id : new Flake.default(data.application_id);
    this.systemChannelFlake = data.system_channel_id === undefined || data.system_channel_id === null ? data.system_channel_id : new Flake.default(data.system_channel_id);
    this.systemChannelFlags = data.system_channel_flags;
    this.rulesChannelFlake = data.rules_channel_id === undefined || data.rules_channel_id === null ? data.rules_channel_id : new Flake.default(data.rules_channel_id);
    ...
    this.channels = data.channels === undefined ? data.channels : (() => {
      ...
      for (const object of data.channels) {
        const subject = new Channel.default({ client: this.client, ...object });
        collection.set(subject.flake.id, subject);
      }
      return collection;
    })();
    this.presences = data.presences === undefined ? data.presences : (() => {
      ...
      for (const object of data.presences) {
        const subject = new Presence.default({ client: this.client, ...object });
        collection.set(subject.user.flake.id, subject);
      }
      return collection;
    })();
    ...
    this.publicUpdatesChannelFlake = data.public_updates_channel_id === undefined || data.public_updates_channel_id === null ? data.public_updates_channel_id : new Flake.default(data.public_updates_channel_id);
  ...
  getIconURL(params) {
    return this.icon === undefined || this.icon === null ? null : this.client.getServerIconURL({ format: params.format, size: params.size, icon: this.icon, id: String(this.flake.id) });
  }
  getSplashURL(params) {
    return this.splash === undefined || this.splash === null ? null : this.client.getServerSplashURL({ format: params.format, size: params.size, splash: this.splash, id: String(this.flake.id) });
  }
  getDiscoverySplashURL(params) {
    return this.discoverySplash === undefined || this.discoverySplash === null ? null : this.client.getServerDiscoverySplashURL({ format: params.format, size: params.size, discoverySplash: this.discoverySplash, id: String(this.flake.id) });
  }
  getBannerURL(params) {
    return this.banner === undefined || this.banner === null ? null : this.client.getServerBannerURL({ format: params.format, size: params.size, banner: this.banner, id: String(this.flake.id) });
  }
}
class ServerPreview extends Base.default {
  constructor(data) {
    super();
    this.client = data.client;
...
class Role extends Base.default {
  get mention() {
...
exports.Role = Role;
class RoleTags extends Base.default {
  constructor(data) {
    super();
    this.botFlake = data.bot_id === undefined ? data.bot_id : new Flake.default(data.bot_id);
    this.integrationFlake = data.integration_id === undefined ? data.integration_id : new Flake.default(data.integration_id);
    this.isPremiumSubscriber = data.premium_subscriber;
  }
}
class Emoji extends Base.default {
  constructor(data) {
    super();
    this.client = data.client;
    this.flake = data.id === undefined || data.id === null ? data.id : new Flake.default(data.id);
    this.name = data.name;
    this.roleFlakes = data.roles === undefined ? data.roles : data.roles.map(element => new Flake.default(element));
  ...
  getEmojiURL(params) {
    return this.flake === undefined || this.flake === null ? null : this.client.getCustomEmojiURL({ size: params.size, animated: Boolean(this.isAnimated), id: String(this.flake.id) });
  }
}
exports.Emoji = Emoji;
class ServerMember extends Base.default {
  constructor(data) {
    super();
    this.client = data.client;
    this.user = data.user === undefined ? data.user : new User.default({ client: this.client, ...data.user });
...
class Ban extends Base.default {
  constructor(data) {
    super();
    this.client = data.client;
    this.reason = data.reason;
    this.user = new User.default({ client: this.client, ...data.user });
  }
}
exports.Ban = Ban;
class VoiceState extends Base.default {
  constructor(data) {
    super();
    this.client = data.client;
    this.serverFlake = data.guild_id === undefined ? data.guild_id : new Flake.default(data.guild_id);
    this.channelFlake = data.channel_id === undefined || data.channel_id === null ? data.channel_id : new Flake.default(data.channel_id);
    this.userFlake = data.user_id === undefined ? data.user_id : new Flake.default(data.user_id);
...
class VoiceRegion extends Base.default {
  constructor(data) {
    super();
    this.id = data.id;
    this.name = data.name;
...
class ServerWidget extends Base.default {
  constructor(data) {
    super();
...
class Template extends Base.default {
  constructor(data) {
    super();
    this.client = data.client;
    this.code = data.code;
    ...
    this.creatorFlake = new Flake.default(data.creator_id);
    this.creator = new User.default({ client: this.client, ...data.creator });
    this.createdTime = Date.parse(data.created_at);
    this.updatedTime = Date.parse(data.updated_at);
    this.serverFlake = new Flake.default(data.source_guild_id);
