...
exports.VoiceState = exports.VoiceRegion = exports.Template = exports.ServerWidgetParams = exports.ServerWidget = exports.ServerPreview = exports.ServerMember = exports.Role = exports.MembershipScreening = exports.Emoji = exports.Ban = void 0;
...
class Server extends Base_1.default {
    constructor(data) {
        ...
        this.welcomeScreen = data.welcome_screen === undefined ? data.welcome_screen : new WelcomeScreen({ _client: this._client, ...data.welcome_screen });
    }
    get joinedDate() {
...
class WelcomeScreen extends Base_1.default {
    constructor(data) {
        ...
        this._client = data._client;
        this.description = data.description;
        this.channels = data.welcome_channels === undefined ? data.welcome_channels : (() => {
            const collection = new Collection_1.default();
            for (const object of data.welcome_channels) {
                const subject = new WelcomeChannel({ _client: this._client, ...object });
                collection.set(subject.flake.id, subject);
            }
            return collection;
        })();
...
class WelcomeChannel extends Base_1.default {
    constructor(data) {
        super();
        this._client = data._client;
        this.flake = data.channel_id === undefined ? data.channel_id : new Flake_1.default(data.channel_id);
        this.description = data.description;
        this.emojiFlake = data.emoji_id === undefined || data.emoji_id === null ? data.emoji_id : new Flake_1.default(data.emoji_id);
    ...
    get emoji() {
        return this.emojiFlake === undefined || this.emojiFlake === null ? this.emojiFlake : this._client.emojis.get(this.emojiFlake.id);
    }
}
class MembershipScreening {
    constructor(data) {
        this.editTime = data.version === undefined ? data.version : Date.parse(data.version);
        this.formFields = data.form_fields === undefined ? data.form_fields : data.form_fields.map(element => new MembershipScreeningField(element));
        this.description = data.description;
    }
}
exports.MembershipScreening = MembershipScreening;
class MembershipScreeningField {
    constructor(data) {
