...
class Server extends Base_1.default {
    constructor(data) {
        ...
        this.roles = data.roles === undefined ? data.roles : (() => {
            ...
            for (const object of data.roles) {
                const subject = new Role({ client: this._client, ...object });
        ...
        this.emojis = data.emojis === undefined ? data.emojis : (() => {
            ...
            for (const object of data.emojis) {
                const subject = new Emoji({ client: this._client, ...object });
                collection.set(subject.flake.id, subject);
            }
            return collection;
        })();
        ...
        this.voiceStates = data.voice_states === undefined ? data.voice_states : (() => {
            ...
            for (const object of data.voice_states) {
                const subject = new VoiceState({ client: this._client, ...object });
        ...
        this.members = data.members === undefined ? data.members : (() => {
            ...
            for (const object of data.members) {
                const subject = new ServerMember({ client: this._client, ...object });
        ...
        this.channels = data.channels === undefined ? data.channels : (() => {
            ...
            for (const object of data.channels) {
                const subject = new Channel_1.default({ client: this._client, ...object });
                collection.set(subject.flake.id, subject);
            }
            return collection;
        })();
        this.presences = data.presences === undefined ? data.presences : (() => {
            ...
            for (const object of data.presences) {
                const subject = new Presence_1.default({ client: this._client, ...object });
                collection.set(subject.user.flake.id, subject);
            }
            return collection;
        })();
    ...
    getIconURL(params) {
        return this.icon === undefined || this.icon === null ? null : this._client.getServerIconURL({ ...params, icon: this.icon, id: String(this.flake.id) });
    }
    getSplashURL(params) {
        return this.splash === undefined || this.splash === null ? null : this._client.getServerSplashURL({ ...params, splash: this.splash, id: String(this.flake.id) });
    }
    getDiscoverySplashURL(params) {
        return this.discoverySplash === undefined || this.discoverySplash === null ? null : this._client.getServerDiscoverySplashURL({ ...params, discoverySplash: this.discoverySplash, id: String(this.flake.id) });
    }
    getBannerURL(params) {
        return this.banner === undefined || this.banner === null ? null : this._client.getServerBannerURL({ ...params, banner: this.banner, id: String(this.flake.id) });
    }
}
...
class Role extends Base_1.default {
    constructor(data) {
        ...
        this.tags = data.tags === undefined ? data.tags : new RoleTags({ client: this._client, ...data.tags });
    }
    get mention() {
...
class Emoji extends Base_1.default {
    ...
    getEmojiURL(params) {
        return this.flake === undefined || this.flake === null ? null : this._client.getCustomEmojiURL({ ...params, animated: Boolean(this.isAnimated), id: String(this.flake.id) });
    }
}
exports.Emoji = Emoji;
...
class VoiceState extends Base_1.default {
    constructor(data) {
        ...
        this.member = data.member === undefined ? data.member : new ServerMember({ client: this._client, ...data.member });
...
class Template extends Base_1.default {
    constructor(data) {
        ...
        this.creatorUser = data.creator === undefined ? data.creator : new User_1.default({ client: this._client, ...data.creator });
        ...
        this.snapshotServer = data.serialized_source_guild === undefined ? data.serialized_source_guild : new Server({ client: this._client, ...data.serialized_source_guild });
