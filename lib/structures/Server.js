...
class Server extends Base_1.default {
    constructor(data) {
        ...
        this.applicationFlake = data.application_id === undefined || data.application_id === null ? data.application_id : new Flake_1.default(data.application_id);
...
class Template extends Base_1.default {
    constructor(data) {
        ...
        this.creator = data.creator === undefined ? data.creator : new User_1.default({ client: this.client, ...data.creator });
        ...
        this.snapshotServer = data.serialized_source_guild === undefined ? data.serialized_source_guild : new Server({ client: this.client, ...data.serialized_source_guild });
