...
class Message extends Base_1.default {
    constructor(data) {
        ...
        this.author = data.author === undefined ? data.author : this.webhookFlake === undefined ? new User_1.default({ client: this.client, ...data.author }) : new Webhook_1.default({ client: this.client, ...data.author });
        ...
        this.mentionRoleFlakes = data.mention_roles === undefined ? data.mention_roles : data.mention_roles.map(element => new Flake_1.default(element));
...
class MessageApplication extends Base_1.default {
    ...
    getIconURL(params) {
        return this.icon === undefined || this.icon === null ? null : this.client.getApplicationIconURL({ format: params.format, size: params.size, appID: String(this.flake.id), icon: this.icon });
    }
    getAssetURL(params) {
        return this.coverImage === undefined ? null : this.client.getApplicationAssetURL({ format: params.format, size: params.size, appID: String(this.flake.id), id: this.coverImage });
    }
}
...
class Reaction extends Base_1.default {
    constructor(data) {
        ...
        this.isMe = data.me;
        this.emoji = data.emoji === undefined ? data.emoji : new Server_1.Emoji({ client: this.client, ...data.emoji });
    }
}
