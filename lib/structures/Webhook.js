...
class Webhook extends Base_1.default {
    constructor(data) {
        ...
        this.appFlake = data.application_id === null ? data.application_id : new Flake_1.default(data.application_id);
    }
    getAvatarURL(params) {
        return this.avatar === null ? this.avatar : this.client.getUserAvatarURL({ format: params.format, size: params.size, avatar: this.avatar, id: String(this.flake.id) });
    }
    getType() {
